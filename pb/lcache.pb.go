...
const file_lcache_proto_rawDesc = "" +
	"\n" +
	"\flcache.proto\x12\x02pb\"1\n" +
	"\aRequest\x12\x10\n" +
...
var file_lcache_proto_depIdxs = []int32{
	0, // 0: pb.lcache_pro.Get:input_type -> pb.Request
	0, // 1: pb.lcache_pro.Set:input_type -> pb.Request
	0, // 2: pb.lcache_pro.Delete:input_type -> pb.Request
	1, // 3: pb.lcache_pro.Get:output_type -> pb.ResponseForGet
	1, // 4: pb.lcache_pro.Set:output_type -> pb.ResponseForGet
	2, // 5: pb.lcache_pro.Delete:output_type -> pb.ResponseForDelete
